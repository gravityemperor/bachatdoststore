...
<article id="post-<?php the_ID(); ?>" <?php post_class('wow slideInUp'); ?>>
	<div class="entry-content content-blog">
		...
		<?php 
		$layout = get_theme_mod('wp_parallax_archive_layout','grid');
		if($layout == 'grid'){
			$image_size = 'wpparallax-blog-grid';
		}else{
			$image_size = 'wpparallax-single-blog-image';
		}
		...
		<div class="main-blog-right">		
			...
			<h3><a href="<?php the_permalink(); ?>" class="title-text"><?php the_title(); ?></a></h3>

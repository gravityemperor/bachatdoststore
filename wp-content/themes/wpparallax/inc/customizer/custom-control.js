jQuery( document ).ready(function($) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.wpparallaxfontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.wpparallaxfontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.wpparallaxfontslist[index].category);

		wpparallaxGetAllSelects($(this).parent().parent());
	});
	...
	function wpparallaxGetAllSelects($element) {
		var selectedFont = {

<?php
	...
	*/
	...
	$plugins = array(
		...
		'required_plugins' => array(
			'operation-demo-importer' => array(
				...
				'class' => 'WOPDI',
				'info' => esc_html__('Adds ability to theme with one click demo import feature, which will help to publish your websies within few minutes.', 'wpparallax'),
			),
	...
	$strings = array(
		...
		'welcome_menu_text' 		=> esc_html__( 'WPparallax Setup', 'wpparallax' ),
		'theme_short_description' 	=> esc_html__( 'Fast &nbsp; | &nbsp; Light  &nbsp; | &nbsp; Powerful', 'wpparallax' ),

		// Plugin Action Texts
		'install_n_activate' 	=> esc_html__('Install and Activate', 'wpparallax'),
		'deactivate' 			=> esc_html__('Deactivate', 'wpparallax'),
		'activate' 				=> esc_html__('Activate', 'wpparallax'),

		// Recommended Plugins Section
		'pro_plugin_title' 			=> esc_html__( 'Pro Plugins', 'wpparallax' ),
		'pro_plugin_description' 	=> esc_html__( 'Take Advantage of some of our Premium Plugins.', 'wpparallax' ),
		'free_plugin_title' 		=> esc_html__( 'Free Plugins', 'wpparallax' ),
		'free_plugin_description' 	=> esc_html__( 'These Free Plugins might be handy for you.', 'wpparallax' ),

		// Demo Actions
		'activate_btn' 		=> esc_html__('Activate', 'wpparallax'),
		'installed_btn' 	=> esc_html__('Activated', 'wpparallax'),
		'demo_installing' 	=> esc_html__('Installing Demo', 'wpparallax'),
		'demo_installed' 	=> esc_html__('Demo Installed', 'wpparallax'),
		'demo_confirm' 		=> esc_html__('Are you sure to import demo content ?', 'wpparallax'),
		'doc_link'			=> 'https://doc.wpoperation.com/wpparallax/',
		...
		'free_vs_pro' => array(
            ...
            'features' => array(
                ...
                'Custom 404'=> array('No', 'Yes', 'dashicons-no-alt', 'dashicons-yes'),
                'Premium Elementor Addons'=> array('5+','25+'),
	...
	*/
	$my_theme_wc_page = new Wpparallax_Welcome( $plugins, $strings );

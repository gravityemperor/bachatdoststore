...
<table class="table">
    <thead>
        <tr>
            <th class="db-bk-color-one"><?php esc_html_e('Product Features', 'wpparallax'); ?></th>
            <th class="db-bk-color-two"><?php esc_html_e('Free', 'wpparallax'); ?></th>
            <th class="db-bk-color-two"><?php esc_html_e('Premium', 'wpparallax'); ?></th>
        </tr>
    </thead>
     <tbody>
...
<?php if(! class_exists('WPparallax_Premium_Addons')){ ?>
<div class="button-wrapper">
    <?php
    $pro_link = 'https://wpoperation.com/themes/wpparallax-pro/';
    ?>
	<a href="<?php echo esc_url($pro_link);?>" class="btn" target="_blank"><?php esc_html_e('Buy Now','wpparallax'); ?></a>
</div>
<?php } ?>
</div><!-- .wpopsection -->
<?php
